    ...
    >
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc pl-5 space-y-1.5">
          <li>
            <strong className="text-foreground">Usage analytics</strong> — We use Google Analytics to see aggregate page
            views and traffic. This helps us fix broken pages and improve tools. Google may set cookies or similar
            identifiers as part of that service.
          </li>
          <li>
